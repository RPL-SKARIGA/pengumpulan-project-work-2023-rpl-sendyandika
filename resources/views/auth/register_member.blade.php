...
<head>
    ...
    <link rel="shortcut icon" href="/front/img/logo1.jpg">
</head>
            ...
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                ...
                <form action="/register_member " class="mt-10" method="POST">
                    ...
                    <div class="my-3">
                        ...
                        <input required type="text" placeholder="Nama Member" name="nama_member" id="nam_member"
                    ...
                    <div class="my-3">
                        <label class="font-semibold" for="detail_alamat">detail_alamat</label>
                        <input required type="text" placeholder="detail_alamat" name="detail_alamat" id="detail_alamat"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
