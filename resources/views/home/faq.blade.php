        ...
        <div class="row">
            ...
            <aside class="sidebar col-sm-3">
                ...
                <div class="contact-item">
                    ...
                    <ul>
                        <li>
                            <i class="fa fa-envelope"></i><a href="mailto:theme@support.com">sendy@gmail.com</a>
                        </li>
                        <li>
                            <i class="fa fa-phone"></i><span>+62 879239139123</span>
                        </li>
                        <li>
                            <i class="fa fa-skype"></i><span>tokosepatu</span>
                        </li>
                    </ul>
                </div>
